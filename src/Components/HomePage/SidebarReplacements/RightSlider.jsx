...
const RightSlider = ({media, reciver, name, data, chatId}) => {
    ...
    return (
        <div className={`h-full bg-[#F8FAFF] dark:text-neutral-300 dark:bg-[#111111] border-l dark:border-neutral-800 transition-all ${!media && "-mr-[20rem]"}`}>
            ...
            {showBox && 
                <div className='absolute left-[25%] top-[40%] bg-white rounded-lg w-[23rem] h-[10rem] flex flex-col items-center justify-center transition-colors dark:bg-neutral-800 text-black dark:text-neutral-200'>
